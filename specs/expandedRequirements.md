...
1. **Project Creation & Management**
   - Create new animation projects with metadata (name, description, dimensions, frame rate)
   - Save and load projects (local storage initially, cloud later)
   - Project dashboard showing all user projects
   - Project templates (standard sizes: 1080p, 4K, social media formats)
   - Project settings (canvas dimensions, background color, default frame rate)
...
2. **Scene Management**
   ...
   - Scene metadata (name, duration, notes)
...
### Features:
1. **Basic Shape Tools**
   - Rectangle tool (click-drag to draw)
   - Circle/Ellipse tool
   - Line tool
